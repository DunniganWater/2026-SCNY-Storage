...
def main() -> None:
    ...
    zb = [{"zone": z,
          ...
          for z in ZONE_ORDER]
    write_js(JS_DIR / "zone-boundaries.js", "ZONE_BOUNDARIES", zb,
             "// Auto-generated by scripts/build_polygons.py - do not edit by hand.\n"
             "// The four SCNY management-zone outlines, for the map overlay.\n"
             "// rings are arrays of [lat, lng] pairs (Leaflet convention).")
    print(f"zone outlines: {len(zb)} zones -> js/zone-boundaries.js")
